 ...
 *  @productversion OSMF 1.0
 */
[Event(name="playStateChange",type="com.seesaw.player.events")]
...
public class AdTrait extends MediaTraitBase {
    ...
    public final function play():void {
        attemptPlayStateChange(AdState.PLAYING);
    }
    ...
    public final function pause():void {
        if (canPause) {
            attemptPlayStateChange(AdState.PAUSED);
        }
        else {
    ...
    public final function stop():void {
        attemptPlayStateChange(AdState.STOPPED);
    }
