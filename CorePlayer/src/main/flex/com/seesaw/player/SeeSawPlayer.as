...
public class SeeSawPlayer extends Sprite {
    ...
    public function init():void {
        ...
        var dispatcher:TraitEventDispatcher = new TraitEventDispatcher();
                   dispatcher.media = mainElement;

                   dispatcher.addEventListener(DynamicStreamEvent.SWITCHING_CHANGE, onSwitchingChange);



       /* mainElement.addEventListener(DynamicStreamEvent.SWITCHING_CHANGE, onSwitchingChange);
        contentElement.addEventListener(DynamicStreamEvent.SWITCHING_CHANGE, onSwitchingChange);
    ...
    private function updateTraitListeners(element:MediaElement, traitType:String, add:Boolean):void {
        switch (traitType) {
            ...
            case MediaTraitType.DYNAMIC_STREAM:
                changeListeners(element, add, traitType, DynamicStreamEvent.SWITCHING_CHANGE, onSwitchingChange);
                break
        }
    }
    ...
    private function onSwitchingChange(event:DynamicStreamEvent):void {
        var trait:DynamicStreamTrait = contentElement.getTrait(MediaTraitType.DYNAMIC_STREAM) as DynamicStreamTrait;
