...
public class CaptionDisplayTrait extends DisplayObjectTrait {
    public function CaptionDisplayTrait(displayObject:DisplayObject, mediaWidth:Number = 0, mediaHeight:Number = 0) {
