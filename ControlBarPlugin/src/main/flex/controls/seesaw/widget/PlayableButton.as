...
public class PlayableButton extends ButtonWidget implements IWidget {
    private var logger:ILogger = LoggerFactory.getClassLogger(PlayableButton);

    public function PlayableButton() {
        logger.debug("PlayableButton Constructor");
    }
    ...
    override protected function onMouseClick(event:MouseEvent):void {
        logger.debug("MOUSE CLICK PLAYABLEBUTTON " + media)
