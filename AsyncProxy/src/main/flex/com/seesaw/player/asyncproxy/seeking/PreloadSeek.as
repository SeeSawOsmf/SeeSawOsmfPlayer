...
*
*****************************************************/
package com.seesaw.player.asyncproxy.seeking
{
import com.seesaw.player.asyncproxy.loader.AsynchLoadingProxyElement;
...
/**
	 ...
	 **/
	public class PreloadSeek extends AsynchLoadingProxyElement
	{
		/**
		 * Constructor.
		 **/
		public function PreloadSeek(proxiedElement:MediaElement = null)
		{
